...
jQuery.fn.slideViewerPro = function(settings) {
	  settings = jQuery.extend({
			...
			thumbsBorderWidth: 2,
			buttonsWidth: 20,
			galBorderColor: "#ffffff",
			thumbsBorderColor: "#ffffff",
			//thumbsActiveBorderColor: "#E60000",
			...
			leftButtonInner: "&laquo;", //could be an image "<img src='images/larw.gif' />" or an escaped char as "&larr";
			rightButtonInner: "&raquo;", //could be an image or an escaped char as "&rarr";
			autoslide: true,
			typo: false,
			typoFullOpacity: 0.9,
			shuffle: false
